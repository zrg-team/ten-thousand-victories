...
Runtime files are `public/art/conquest-ui-icons/icons-v5.png` and `icons-v5.json`: 57 semantic frames, 1024×1024, 4 MiB decoded, 747,368 PNG bytes. Six frame rectangles change; all 51 other frame entries retain their v4 pixels and coordinates. Earlier UI atlases are excluded from the offline shell.
...
Final verification results are recorded below when complete.
