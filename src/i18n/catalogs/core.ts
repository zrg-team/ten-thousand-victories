...
export const enCore = {
  ...
  "menu.trailer.button": "Trailer",
  "menu.trailer.link": "watch the trailer",
  "menu.trailer.linkAlone": "Watch the trailer",
  "menu.trailer.title": "Vạn Thắng trailer",
  "menu.trailer.close": "Close the trailer",
  "menu.trailer.failed": "The trailer can't play here. Check your connection, or watch it on the game's page.",
  "menu.quit": "Exit",
  ...
  "menu.mapLife": "MAP LIFE",
  "menu.tileAssets": "TILE ASSETS",
  "menu.tileAssets.note": "Grass background images. Turn off for painted ground.",
  "menu.mapLife.off": "Off",
  "menu.mapLife.calm": "Calm",
  "menu.mapLife.full": "Full",
  "menu.mapLife.note": "Kitchen smoke over the villages, mist drifting on the wind, butterflies over forest and meadow, smoke over a fight. Desktop only.",
  "menu.traffic": "ROADS",
  ...
  "menu.mapDepth": "MAP DEPTH",
  "menu.mapDepth.off": "Off",
  "menu.mapDepth.mist": "Mist",
  "menu.mapDepth.tilt": "Tilt",
  "menu.mapDepth.deep": "Deep",
  "menu.mapDepth.lens": "Lens",
  "menu.mapDepth.mist.note": "The far map fades into paper mist and loses colour; the middle stays vivid. Map only.",
  "menu.mapDepth.tilt.note": "The top and bottom of the map go soft, like a model table seen through a lens. Map only.",
  "menu.mapDepth.deep.note": "Soft focus, mist and fading colour together, so the middle of the map stands forward. Map only.",
  "menu.mapDepth.lens.note": "A narrow sharp band, colour drained with distance, soft corners. The strongest look. Map only.",
  "menu.mapDepth.miniature": "Sa bàn",
  "menu.mapDepth.miniature.note": "Tilt-shift photography: a narrow sharp band and toy-bright colour, so the realm looks like the generals' sand table. Map only.",
  "menu.mapStyle": "MAP MATERIAL",
  "menu.mapStyle.off": "Off",
  "menu.mapStyle.amount": "MATERIAL AMOUNT",
  "menu.mapStyle.pixel": "Pixel",
  "menu.mapStyle.stitch": "Embroidery",
  "menu.mapStyle.ink": "Court map",
  "menu.mapStyle.photo": "Old photo",
  "menu.mapStyle.silk": "Silk",
  "menu.mapStyle.pixel.note": "The map re-woven in square cells from the Đông Hồ printer's own pigments, with a dot-screen dither. Map only.",
  "menu.mapStyle.stitch.note": "Tranh thêu: every cell a cross-stitch in pigment-coloured thread, bare cloth where the ground is paper. Map only.",
  "menu.mapStyle.ink.note": "A court map in soot and indigo wash, only your red left in colour. Kingdom colours turn to ink. Map only.",
  "menu.mapStyle.photo.note": "An albumen print from the 1900s: sepia, soft light at the edges, your red hand-tinted like a postcard. Map only.",
  "menu.mapStyle.silk.note": "Tranh lụa: soft, warm and pale, the ink breathing a little into the silk. Map only.",
  "menu.mapDepth.amount": "DEPTH AMOUNT",
  "menu.mapDepth.clouds": "FAR CLOUDS",
  ...
  "msg.needFoodArmy": "Need [[food]]{amount} to send with that army.",
  "msg.needGoldBribe": "Need [[gold]]{cost} to attempt this bribe.",
  "msg.needHumansSettlers": "Need [[humans]]{cost} to send settlers into the wilderness.",
  "msg.needSuppliesArmy": "Need [[supplies]]{amount} to equip and provision that army.",
  "msg.needGoldArmy": "Need [[gold]]{amount} to pay the bounty and arm that many men.",
  "msg.needSuppliesDiplomacy": "Need [[supplies]]{cost} for diplomatic gifts and hospitality.",
  ...
  "msg.populationBonus": " [[humans]]+{population}.",
  ...
  "campaign.affairs.gift": "Send Gift ([[gold]]−30, +15 relations)",
...
export const viCore = {
  ...
  "menu.trailer.button": "Trailer",
  "menu.trailer.link": "xem trailer",
  "menu.trailer.linkAlone": "Xem trailer",
  "menu.trailer.title": "Trailer Vạn Thắng",
  "menu.trailer.close": "Đóng trailer",
  "menu.trailer.failed": "Không phát được trailer ở đây. Hãy kiểm tra kết nối mạng, hoặc xem trên trang giới thiệu game.",
  "menu.quit": "Thoát",
  ...
  "menu.mapLife": "HƠI THỞ BẢN ĐỒ",
  "menu.tileAssets": "ẢNH NỀN Ô ĐẤT",
  "menu.tileAssets.note": "Ảnh nền cỏ. Tắt để dùng nền đất vẽ.",
  "menu.mapLife.off": "Tắt",
  "menu.mapLife.calm": "Nhẹ",
  "menu.mapLife.full": "Đầy đủ",
  "menu.mapLife.note": "Khói bếp trên làng, sương mây trôi theo gió, bướm trên rừng và đồng cỏ, khói nơi trận đánh. Chỉ trên máy tính.",
  ...
  "menu.mapDepth": "CHIỀU SÂU BẢN ĐỒ",
  "menu.mapDepth.off": "Tắt",
  "menu.mapDepth.mist": "Sương",
  "menu.mapDepth.tilt": "Nghiêng",
  "menu.mapDepth.deep": "Chiều sâu",
  "menu.mapDepth.lens": "Ống kính",
  "menu.mapDepth.mist.note": "Phía xa tan vào sương giấy và nhạt màu; giữa bản đồ vẫn tươi. Chỉ trên bản đồ.",
  "menu.mapDepth.tilt.note": "Trên và dưới bản đồ nhoè đi như nhìn sa bàn qua ống kính. Chỉ trên bản đồ.",
  "menu.mapDepth.deep.note": "Nhoè, sương và nhạt màu cùng lúc, để giữa bản đồ nổi lên phía trước. Chỉ trên bản đồ.",
  "menu.mapDepth.lens.note": "Dải nét hẹp, xa thì mất màu, góc mềm. Kiểu mạnh nhất. Chỉ trên bản đồ.",
  "menu.mapDepth.miniature": "Sa bàn",
  "menu.mapDepth.miniature.note": "Nhiếp ảnh tilt-shift: dải nét hẹp, màu tươi như đồ chơi, bờ cõi trông như sa bàn của các tướng. Chỉ trên bản đồ.",
  "menu.mapStyle": "CHẤT LIỆU BẢN ĐỒ",
  "menu.mapStyle.off": "Tắt",
  "menu.mapStyle.amount": "ĐỘ ĐẬM",
  "menu.mapStyle.pixel": "Điểm ảnh",
  "menu.mapStyle.stitch": "Tranh thêu",
  "menu.mapStyle.ink": "Bản đồ triều",
  "menu.mapStyle.photo": "Ảnh xưa",
  "menu.mapStyle.silk": "Tranh lụa",
  "menu.mapStyle.pixel.note": "Bản đồ dệt lại bằng ô vuông từ chính các màu của thợ in Đông Hồ, chấm lưới xen màu. Chỉ trên bản đồ.",
  "menu.mapStyle.stitch.note": "Tranh thêu: mỗi ô một mũi chữ thập bằng chỉ màu, để trơn nền vải chỗ đất là giấy. Chỉ trên bản đồ.",
  "menu.mapStyle.ink.note": "Bản đồ triều đình bằng mực và nước chàm, chỉ màu đỏ của ta còn giữ. Màu các nước thành mực. Chỉ trên bản đồ.",
  "menu.mapStyle.photo.note": "Ảnh in lòng trắng trứng thời 1900: nâu đỏ, mép sáng mềm, màu đỏ của ta tô tay như bưu thiếp. Chỉ trên bản đồ.",
  "menu.mapStyle.silk.note": "Tranh lụa: mềm, ấm và nhạt, mực loang nhẹ vào mặt lụa. Chỉ trên bản đồ.",
  "menu.mapDepth.amount": "ĐỘ SÂU",
  "menu.mapDepth.clouds": "MÂY PHÍA XA",
  "menu.layout": "BỐ CỤC",
  ...
  "msg.disbands": "{army} giải tán. [[humans]]{humans} trở về; XP bị mất.",
  ...
  "msg.needFoodArmy": "Cần [[food]]{amount} để gửi theo đạo quân đó.",
  "msg.needGoldBribe": "Cần [[gold]]{cost} để hối lộ.",
  "msg.needHumansSettlers": "Cần [[humans]]{cost} để đưa người khai khẩn vào hoang địa.",
  "msg.needSuppliesArmy": "Cần [[supplies]]{amount} để trang bị và tiếp tế đạo quân đó.",
  "msg.needGoldArmy": "Cần [[gold]]{amount} để phát tiền tuyển và sắm khí giới cho ngần ấy quân.",
  "msg.needSuppliesDiplomacy": "Cần [[supplies]]{cost} cho quà ngoại giao và tiếp đãi.",
  ...
  "msg.unpaidDisbanded": "{army} tan rã vì nợ lương. [[humans]]{humans} trở về.",
  ...
  "campaign.affairs.gift": "Tặng quà ([[gold]]−30, +15 quan hệ)",
